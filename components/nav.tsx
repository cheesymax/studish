                    ...
                    <button className="relative group ml-6 outline-0"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    className={`bg-black h-[3px] w-6 rounded transform transition-all duration-300 origin-left ${menuShow ? "translate-y-8 delay-100" : ""}`}/>
                                <div
                                    className={`bg-black h-[3px] w-6 rounded transform transition-all duration-300 ${menuShow ? "translate-y-8 delay-75" : ""}`}/>
                                <div
                                    className={`bg-black h-[3px] w-5 rounded transform transition-all duration-300 origin-left ${menuShow ? "translate-y-8" : ""}`}/>

                                <div
                                    className={`absolute items-center justify-between transform transition-all duration-500 top-2.5 -translate-x-10 ${menuShow ? "translate-x-0 flex w-0 w-12" : ""}`}>
                                    <div
                                        className={`absolute bg-black h-[3px] w-6 rounded transform transition-all duration-500 rotate-0 delay-300 ${menuShow ? "rotate-45" : ""}`}/>
                                    <div
                                        className={`absolute bg-black h-[3px] w-6 rounded transform transition-all duration-500 -rotate-0 delay-300 ${menuShow ? "-rotate-45" : ""}`}/>
                                </div>
                            </div>
